...
## Problema 2 — Banco 'empresa' não criado automaticamente na restauração
**Erro:** `ERROR 1049 (42000): Unknown database 'empresa'`  
**Causa:** O volume já tinha dados antigos do MySQL, então a variável `MYSQL_DATABASE` foi ignorada  
...
**Causa:** README editado direto no GitHub, deixando o remoto à frente do local  
...
**Causa:** Pasta `backups/` não existia no momento da execução  
**Solução:** Criar a pasta com `mkdir -p backups/` antes de executar o comando
